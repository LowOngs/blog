...
const PLAN_LIBRARY = {
  'avoid-leak': [
    ...
    'unused insurance extras',
    'automatic renewals',
    'hidden service fees',
    'family subscription overlap',
    'forgotten memberships',
    'digital storage upgrades',
  ],
  optimize: [
    'mobile data usage',
    'home internet plan value',
    ...
    'recurring service bundles',
  ],
  replace: [
    'paid apps with free alternatives',
    'expensive delivery habits',
    ...
    'high-cost entertainment services',
    'paid note-taking apps',
    'premium video editing tools',
    'expensive grocery habits',
    'paid design tools',
  ...
  reduce: [
    'electricity usage without discomfort',
    'mobile data use',
    'food waste at home',
    'delivery orders',
    'paid app renewals',
